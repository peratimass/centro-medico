...
Begin VB.Form FrmregistroDiarioList 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   9135
   ClientLeft      =   0
   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":0000
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":0454
            Key             =   "(ImportarExcel)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":09EE
            Key             =   "(Cerrar)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":0F88
            Key             =   "(Abrir)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":1522
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":1842
            Key             =   "(Anular)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":1B5C
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":1FB0
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":2404
            Key             =   "(RCompras)"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroDiarioList.frx":3B76
            Key             =   "(RVentas)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmregistroDiarioList"
 ...
 End If
   ...
   strCadena = "P_insert_venta('" & TxtTipoComprobante.Text & "','" & id_alm & "','" & Trim(Me.DtcFormaPago.BoundText) & "','" & Trim(Me.DtcMoneda.BoundText) & "','no'," & _
        ...
        Else
            forma_pago = "08"
        End If
        strCadena = "P_insert_pagoventa('" & id_venta & "','" & forma_pago & "','" & Val(Me.txttotal.Text) & "','0','0','0','" & FrmRegistroDiario.TxtRuc.Text & "')"
        CnBd.Execute (strCadena)
   ...
   '-----ii
        ...
        strCadena = "UPDATE almacen_comprobante SET numero='" & StrNumero & "' WHERE id_alm='" & Trim(id_alm) & "' AND id_doc='" & Trim(TxtTipoComprobante.Text) & "' AND serie='" & Trim(Me.TxtSerie.Text) & "' AND ruc='" & Trim(FrmRegistroDiario.TxtRuc.Text) & "'"
        CnBd.Execute (strCadena)
...
Me.Top = 50
correlativo = 0
strCadena = "SELECT * FROM entidad_parametros WHERE cod_unico='" & Trim(FrmRegistroDiario.TxtRuc.Text) & "'"
Call ConfiguraRst(strCadena)
...
End If
Set rst = Nothing
Me.LblEmpresa.Caption = FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 6) + "***[" + Space(1) + FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 0) + Space(1) + "]***"
Me.lblMes.Caption = FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 2) + Space(2) + FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 3)
Me.txtRucEmpresa.Text = FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 0)
...
Me.DtcFormaPago.BoundText = "01"
  ...
  Me.dtcmes.BoundText = FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 1)
  Me.dtcmes.Enabled = False
  Me.txtanio.Text = FrmRegistroDiario.HfdPersona.TextMatrix(FrmRegistroDiario.HfdPersona.Row, 3)
  ...
  Select Case Button.key
    ...
    Case KEY_DELETE
      ...
      Case KEY_IMPEXCEL
            ...
            'Caracteristicas
            'FormatearTabla
            'Call LlenadoDeTabla(FrmRegistroDiario.TxtRuc.text, Me.DtcMes.BoundText, Me.TxtAnio.text)
    Case "(Verificar)"
        FrmRegistroDiarioDetalleBuscar.Show
    Case KEY_ACTUALIZAR
        Call llenarGrid(Me.HfdPersona, Trim(Me.txtRucEmpresa.Text))
    Case KEY_EXIT
...
If KeyAscii = 13 Then
    ...
    strCadena = "SELECT * FROM movimiento_venta WHERE id_doc='" & Trim(Me.TxtTipoComprobante) & "' AND serie='" & Trim(Me.TxtSerie.Text) & "' AND numero='" & Trim(Me.txtnumero.Text) & "' AND ruc='" & Trim(FrmRegistroDiario.TxtRuc.Text) & "'"
    Call ConfiguraRst(strCadena)
    If rst.RecordCount > 0 Then
...
If KeyAscii = 13 Then
    Me.TxtSerie.Text = formato_item(Me.TxtSerie.Text, 3)
    strCadena = "SELECT * FROM movimiento_venta WHERE ruc='" & Trim(FrmRegistroDiario.TxtRuc.Text) & "' AND serie='" & Trim(Me.TxtSerie.Text) & "' AND id_doc='" & Trim(Me.TxtTipoComprobante.Text) & "' ORDER BY numero DESC"
    Call ConfiguraRst(strCadena)
    If rst.RecordCount > 0 Then
        rst.MoveFirst
