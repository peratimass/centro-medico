...
Begin VB.Form FrmParteMaquinariaLista 
   BorderStyle     =   0  'None
   Caption         =   "Form2"
   ClientHeight    =   7620
   ClientLeft      =   0
   ...
   Begin VB.CommandButton Command1 
      Height          =   330
      Left            =   4480
      Picture         =   "FrmParteMaquinariaLista.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   200
      Width           =   495
   ...
   Begin VB.CommandButton Command2 
      Height          =   330
      Left            =   14430
      Picture         =   "FrmParteMaquinariaLista.frx":014A
      Style           =   1  'Graphical
      TabIndex        =   11
      Top             =   200
      Width           =   495
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":0294
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":06E8
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":0A08
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":0E5C
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":12B0
            Key             =   "(Aceptar)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":15D0
            Key             =   "(Buscar)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmParteMaquinariaLista.frx":18F0
            Key             =   "(Reporte)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmParteMaquinariaLista"
...
End If
   ...
   Grilla.Rows = 0
       ...
       For Each Campo In rst.Fields
        ...
        Next
        cabecera = "IDPARTE" & vbTab & "EMISION" & vbTab & "COMPROBANTE" & vbTab & "OPERADOR" & vbTab & "TRANSPORTE" & vbTab & "HORAS" & vbTab & "PRECIO" & vbTab & "P.TOTAL" & vbTab & "USO COMBUST" & vbTab & "SALDO COMBUST"
        ...
        For i = 0 To rst.RecordCount - 1
            ...
            Fila = rst("id_parte") & vbTab & rst("fecha") & vbTab & rst("comprobante") & vbTab & UCase(rst("beneficiario")) & vbTab & rst("transporte") & vbTab & Format(rst("horas"), "#,##0.00") & Space(2) & "Hs" & vbTab & Format(rst("precio"), "#,##0.00") & Space(2) & vbTab & Space(2) & Format(rst("horas") * rst("precio"), "#,##0.00") & vbTab & Format(rst("uso_combustible"), "#,##0.00") & Space(2) & "Gl" & vbTab & Format(rst("combustible_actual"), "#,##0.00") & Space(2) & "Gl"
            Grilla.AddItem Fila
           ...
           Else
            ...
            tcombustible = tcombustible + rst("uso_combustible")
            tHoras = tHoras + rst("horas")
            tTotal = tTotal + rst("precio") * rst("horas")
            End If
            Fila = ""
            rst.MoveNext
        Next i
        cabecera = "" & vbTab & "" & vbTab & "" & vbTab & "" & vbTab & "" & vbTab & Format(tHoras, "#,##0.00") & Space(2) & "Hs" & vbTab & "" & vbTab & "S/." & Space(2) & Format(tTotal, "#,##0.00") & Space(2) & vbTab & Format(tcombustible, "#,##0.00") & Space(2) & "Gl"
        Grilla.AddItem cabecera
         For k = 5 To 9
                                Grilla.col = k
                                Grilla.Row = i + 1
...
Private Sub Command1_Click()
    strCadena = "SELECT P.id_parte,P.fecha,CONCAT(C.doc_abrev,':',P.serie,'-',P.numero) as comprobante,PP.nombre_completo as beneficiario,CONCAT(TT.descripcion,'-',T.placa) as transporte,anulado,horas,precio,uso_combustible,petroleo,precio_petroleo,gasolina,pecio_gasolina,combustible_actual,dni_save FROM parte_maquinaria P,comprobantes C,persona PP,transporte T,transporte_tipo TT WHERE T.id_tipo_transporte=TT.id_tipo_transporte AND P.id_transporte=T.id_transporte AND P.id_operador=PP.dni AND P.id_doc=C.id_doc AND P.ruc='" & KEY_RUC & "' AND T.ruc='" & KEY_RUC & "' AND TT.ruc='" & KEY_RUC & "' AND P.id_cantera = '" & Trim(DtcAlmacen.BoundText) & "' ORDER BY P.fecha ASC  "
    Call llenarGrid(Me.HfgFacturas, Me)
...
strCadena = "SELECT P.id_parte,P.fecha,CONCAT(C.doc_abrev,':',P.serie,'-',P.numero) as comprobante,PP.nombre_completo as beneficiario,CONCAT(TT.descripcion,'-',T.placa) as transporte,anulado,horas,precio,uso_combustible,petroleo,precio_petroleo,gasolina,pecio_gasolina,combustible_actual,dni_save FROM parte_maquinaria P,comprobantes C,persona PP,transporte T,transporte_tipo TT WHERE T.id_tipo_transporte=TT.id_tipo_transporte AND P.id_transporte=T.id_transporte AND P.id_operador=PP.dni AND P.id_doc=C.id_doc AND P.ruc='" & KEY_RUC & "' AND T.ruc='" & KEY_RUC & "' AND TT.ruc='" & KEY_RUC & "' AND PP.nombre_completo like '%" & Trim(Me.TxtRuc.Text) & "%' AND P.fecha>='" & Format(Me.DtpFechaIni.Value, "YYYY-mm-dd") & "' AND P.fecha<='" & Format(Me.DtpFechaFin.Value, "YYYY-mm-dd") & "' AND T.placa LIKE '%" & Trim(Me.TxtcodProveedor.Text) & "%'  ORDER BY P.fecha ASC  "
Call llenarGrid(Me.HfgFacturas, Me)
End Sub
...
strCadena = "SELECT E.cod_unico as Codigo, P.nombre_completo as Descripcion FROM entidad_empresa E,persona P WHERE E.cod_unico=P.dni AND E.id_empresa='" & KEY_RUC & "' AND E.id_proveedor='si'  ORDER BY descripcion "
Call ConfiguraRst(strCadena)
...
Private Sub TxtcodProveedor_Change()
    strCadena = "SELECT P.id_parte,P.fecha,CONCAT(C.doc_abrev,':',P.serie,'-',P.numero) as comprobante,PP.nombre_completo as beneficiario,CONCAT(TT.descripcion,'-',T.placa) as transporte,anulado,horas,precio,uso_combustible,petroleo,precio_petroleo,gasolina,pecio_gasolina,combustible_actual,dni_save FROM parte_maquinaria P,comprobantes C,persona PP,transporte T,transporte_tipo TT WHERE T.id_tipo_transporte=TT.id_tipo_transporte AND P.id_transporte=T.id_transporte AND P.id_operador=PP.dni AND P.id_doc=C.id_doc AND P.ruc='" & KEY_RUC & "' AND T.ruc='" & KEY_RUC & "' AND TT.ruc='" & KEY_RUC & "' AND T.placa LIKE '%" & Trim(Me.TxtcodProveedor.Text) & "%' ORDER BY P.fecha ASC  "
    Call llenarGrid(Me.HfgFacturas, Me)
...
Private Sub TxtRuc_Change()
    strCadena = "SELECT P.id_parte,P.fecha,CONCAT(C.doc_abrev,':',P.serie,'-',P.numero) as comprobante,PP.nombre_completo as beneficiario,CONCAT(TT.descripcion,'-',T.placa) as transporte,anulado,horas,precio,uso_combustible,petroleo,precio_petroleo,gasolina,pecio_gasolina,combustible_actual,dni_save FROM parte_maquinaria P,comprobantes C,persona PP,transporte T,transporte_tipo TT WHERE T.id_tipo_transporte=TT.id_tipo_transporte AND P.id_transporte=T.id_transporte AND P.id_operador=PP.dni AND P.id_doc=C.id_doc AND P.ruc='" & KEY_RUC & "' AND T.ruc='" & KEY_RUC & "' AND TT.ruc='" & KEY_RUC & "' AND PP.nombre_completo LIKE '%" & Trim(Me.TxtRuc.Text) & "%' ORDER BY P.fecha ASC  "
    Call llenarGrid(Me.HfgFacturas, Me)
