   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":0000
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":0454
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":0774
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":0BC8
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":101C
            Key             =   "(Aceptar)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":133C
            Key             =   "(Cancelar)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":165C
            Key             =   "(Quitar)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":197C
            Key             =   "(Agregar)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLaboratorio.frx":1C9C
            Key             =   "(Buscar)"
         EndProperty
      EndProperty
   End
...
Private Sub Form_Activate()
  ...
  "FROM Persona WHERE proveedor='V' ORDER BY NombrePersona ASC"
...
strCadena = "SELECT cpersona as Código,NombrePersona  " & _
  "as Nombre, sRazonSocial as Razon_Social, sDireccionCliente1 as Direccion,Per_Ruc as RUC " & _
  "FROM Persona WHERE (NombrePersona LIKE '%" & Trim(Me.TxtApellido.Text) & "%' AND proveedor='V') ORDER BY NombrePersona ASC"
Call llenarGrid(Me.HfdPersona, Me)
End Sub
...
strCadena = "SELECT cpersona as Código,NombrePersona  " & _
  "as Nombre, sRazonSocial as Razon_Social, sDireccionCliente1 as Direccion,Per_Ruc as RUC " & _
  "FROM Persona WHERE (int_persona = '" & Val(Me.txtcodigo.Text) & "' AND proveedor='V')ORDER BY sRazonSocial ASC"
Call llenarGrid(Me.HfdPersona, Me)
End Sub
...
strCadena = "SELECT cpersona as Código,NombrePersona  " & _
  "as Nombre, sRazonSocial as Razon_Social, sDireccionCliente1 as Direccion,Per_Ruc as RUC " & _
  "FROM Persona WHERE (sRazonSocial LIKE '%" & Trim(Me.TxtRazonSocial.Text) & "%' AND proveedor='V')ORDER BY sRazonSocial ASC"
Call llenarGrid(Me.HfdPersona, Me)
End Sub
...
strCadena = "SELECT cpersona as Código,NombrePersona  " & _
  "as Nombre, sRazonSocial as Razon_Social, sDireccionCliente1 as Direccion,Per_Ruc as RUC " & _
  "FROM Persona WHERE (Per_Ruc LIKE '%" & Trim(Me.TxtRuc.Text) & "%' AND proveedor='V')ORDER BY sRazonSocial ASC"
Call llenarGrid(Me.HfdPersona, Me)
End Sub
