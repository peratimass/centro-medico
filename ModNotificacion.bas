Attribute VB_Name = "ModNotificacion"
Option Explicit
...
Public Sub SlideForm(FRM As Form, _
                     ...
                     Optional Velocidad As Integer = 1, Optional in_fecha As String, Optional in_mensaje As String)
...
If Direccion = mostrar Then
    ...
    '''''''''''''''''''''''''''''''''''''''''''''''''''''
    Do While FRM.Height <= 5085 ' la altura que se quiera
        DoEvents
        ...
        End If
    Loop
    FRM.lblfecha_suspencion.Caption = UCase(Format(in_fecha, "dd-mmmm-YYYY"))
    'FRM.lblmensaje.Caption = in_mensaje
Else
