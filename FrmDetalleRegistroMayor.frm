...
Begin VB.Form FrmDetalleRegistroMayor 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   3855
   ClientLeft      =   0
   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":0000
            Key             =   "(Aceptar)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":031C
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":077C
            Key             =   "(Inicio)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":0BDC
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":0EF8
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":1358
            Key             =   "(Quitar)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":1674
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":1AD4
            Key             =   "(Red)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":1F34
            Key             =   "(Grabar)"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":2814
            Key             =   "(Agregar)"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":2B30
            Key             =   "(Buscar)"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleRegistroMayor.frx":2E4C
            Key             =   "(Cancelar)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmDetalleRegistroMayor"
...
CenterForm Me
Me.Top = 2000
Me.TxtEmpresa.Text = Trim(FrmRegistroMayor.TxtEmpresa.Text)
Me.TxtRuc.Text = Trim(FrmRegistroMayor.TxtRuc.Text)
...
Dim descripcion As String
  ...
  Else
     ...
     Select Case FrmRegistroMayor.Procedencia
     Case nuevo
...
Nombre = App.Path & "\excel\" & "mayor.xlsx"
Screen.MousePointer = vbHourglass
    ...
    ' Recorre las filas y columnas de la hoja
       ...
       Fila_Actual = i
       acum = 0
      ' strCadena = "DELETE FROM registro_mayor_detalle "
       'CnBd.Execute (strCadena)
       ...
       Do While (i < 10000)
            ...
            If Val(correlativo) > 0 Then
                ...
                strCadena = "SELECT count(*) FROM registro_mayor_detalle WHERE ruc='" & ruc & "' AND id_mes='" & id_mes & "' AND id_anio='" & id_anio & "' AND id_cuenta='" & Trim(codigo) & "'"
                Call ConfiguraRstT(strCadena)
                    If rstT(0) > 0 Then
                        correlativo = formato_item(Val(correlativo) + 1, 2)
                    Else
                        strCadena = "SELECT * FROM registro_mayor_detalle WHERE ruc='" & ruc & "' AND id_mes='" & id_mes & "' AND id_anio='" & id_anio & "' ORDER BY num_correlativo DESC LIMIT 0,1"
                        Call ConfiguraRstT(strCadena)
                        If rstT.RecordCount > 0 Then
            ...
            If Val(correlativo) > 0 And IsDate(fechaI) = True And IsNull(CVDate(fechaI)) = False Then
                ...
                strCadena = "INSERT INTO registro_mayor_detalle (id_mes,id_anio,num_correlativo,fecha,glosa,id_cuenta,denominacion,debe,haber,ruc) " & _
