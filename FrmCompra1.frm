...
If Trim(Me.txtvalidacion_chasis.Text) = "si" And Trim(Me.txtnumero_dua.Text) = "" And Trim(Me.txtAñoFabricacion.Text) = "" Then
   validar_fua = False
...
If rst.RecordCount > 0 Then
   idCompra = rst("id_compra")
    ...
    End If
     ...
     "id_moneda='" & Me.DtcMoneda.BoundText & "',anio_fabricacion='" & Trim(Me.txtAñoFabricacion.Text) & "',serie_dua='" & Trim(Me.txtseriedua.Text) & "',numero_dua='" & Trim(Me.txtnumero_dua.Text) & "',id_mes='" & formato_item(Month(KEY_FECHA), 2) & "',id_anio='" & Year(KEY_FECHA) & "',id_alm='" & Me.DtcAlmacen.BoundText & "',id_doc='" & Me.DtcTipoDoc.BoundText & "'," & _
...
If rst.RecordCount > 0 Then
    For i = 0 To in_cantidad - 1
        ...
        "('" & in_compra & "','" & in_detalle_compra & "','" & in_producto & "','" & Me.DtcAlmacen.BoundText & "','" & Trim(Me.txtAñoFabricacion.Text) & "'," & _
