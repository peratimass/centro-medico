...
contenido = Me.wbrInfo.Document.documentElement.innerHTML
    ...
    PosNomCom = InStr(1, wbrInfo.Document.documentElement.innerHTML, "Resultado de la Calificación") + 1
    PosNomCom = InStr(PosNomCom, wbrInfo.Document.documentElement.innerHTML, ">") + 1
    PosNomCFin = InStr(PosNomCom, wbrInfo.Document.documentElement.innerHTML, "</")
...
End If
       ...
       For Each Campo In rstT.Fields
        ...
        cabecera = "ID" & vbTab & "FECHA VENTA" & vbTab & "COMPROBANTE" & vbTab & "TOTAL" & vbTab & "SALDO" & vbTab & "DNI/RUC" & vbTab & "CLIENTE" & vbTab & "DETALLE VEHICULO" & vbTab & "COLOR" & vbTab & "Nº CHASIS" & vbTab & "N°SERIE" & vbTab & "FECHA REG" & vbTab & "Nº TARJETA" & vbTab & "Nº PLACA" & vbTab & "IDVENTA"
