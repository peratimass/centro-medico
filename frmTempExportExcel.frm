...
Private Sub Form_Load()
    ...
    Select Case TipoReg
        Case 1 'Ventas
            ...
            Call addELista(lstOrigen, 9, "Exportación")
            ...
            Call addELista(lstOrigen, 17, "Retención")
        ...
        Case 0 'Compras
            ...
            Call addELista(lstOrigen, 2, "Año DUA")
            ...
            Call addELista(lstOrigen, 18, "Percepción")
            Call addELista(lstOrigen, 19, "Otros")
            Call addELista(lstOrigen, 20, "Total")
            Call addELista(lstOrigen, 21, "N.Comp. No Domiciliado")
            Call addELista(lstOrigen, 22, "N.Const.Detracción")
            Call addELista(lstOrigen, 23, "Fec.Const.Detracción")
...
Private Sub cmdExport_Click()
    ...
    If Exportar_Excel_vv(RutaArchivo) Then
        FrmRegistroVentas.Procedencia = Neutro
        MsgBox "La exportación concluyó satisfactoriamente"
...
Private Function Exportar_Excel(sOutputPath As String) As Boolean
  ...
  End If
    ...
    o_Hoja.Cells(Fila + 4, columna).Value = "Apellidos y Nombres, Denominación o Razón Social: " & KEY_EMPRESA
    ...
    If chkNRegs.Value Then
        If Val(txtNRegs.Text) > 0 Then
            ...
            If DivReg >= 30 And DivReg <= 100 Then
                'Funcion de aproximación al zoom ideal en esa cantidad de lineas por pagina
    ...
    ElseIf optCustom.Value Then
        ...
        For i = 0 To lstDestino.ListCount - 1
            ...
            Select Case lstDestino.List(i)
                ...
                Case "Exportación": FlagExport = True
                ...
                Case "Retención": FlagPerRet = True
                Case "Año DUA": FlagAnDua = True
                ...
                Case "Percepción": FlagPerRet = True
                Case "N.Comp. No Domiciliado": FlagNoDom = True
                Case "N.Const.Detracción": FlagDetracNum = True
                Case "Fec.Const.Detracción": FlagDetracFec = True
...
Private Sub EscribeCabeceras(ByRef o_Hoja As Object, Fila As Long, columna As Long)
    ...
    Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Número correlativo del registro o código único de la operación")
    columna = columna + 1

    Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Fecha de emisión del comprobante de pago o documento", 11)
    columna = columna + 1
    ...
    Select Case TipoReg
        Case 1, 6
            Call SetEstiloCab(o_Hoja, Fila + 1, columna, Fila + 2, columna, "Nº de Serie", 4.5)
            columna = columna + 1
            Call SetEstiloCab(o_Hoja, Fila + 1, columna, Fila + 2, columna, "Número")
            ColNumero = columna
            columna = columna + 1
        Case 0
            ...
            If FlagAnDua Then
                Call SetEstiloCab(o_Hoja, Fila + 1, columna, Fila + 2, columna, "Año DUA", 4)
                columna = columna + 1
            End If
            
            Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Nº Doc, Formulario, DUA, DSI, Liquid. Cobranza u Otros Doc SUNAT para acreditar crédito fiscal")
            ColNumero = columna
            columna = columna + 1
    End Select
    
    Call SetEstiloCab(o_Hoja, Fila, columna, Fila, columna + 2, IIf(TipoReg = 1, "Información del cliente", "Información del proveedor"))
    ...
    columna = columna + 1
    Call SetEstiloCab(o_Hoja, Fila + 1, columna, Fila + 2, columna, "Apellidos y Nombres, Denominación o Razón Social", 50)
    ColNomEntidad = columna
    columna = columna + 1
    ...
    If FlagInafecto And TipoReg = 6 Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Importe de la operación inafecta")
        columna = columna + 1
    End If
    ...
    If FlagExport Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Valor facturado de la exportación")
        columna = columna + 1
    End If
        
    If FlagAfecto Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Base Imponible de la operación gravada")
        columna = columna + 1
    End If
    
    If (FlagExonerado Or FlagInafecto) And TipoReg = 1 Then
        If FlagExonerado And FlagInafecto Then
            Call SetEstiloCab(o_Hoja, Fila, columna, Fila, columna + 1, "Importe total de la operación exonerada e inafecta")
        Else
            Call SetEstiloCab(o_Hoja, Fila, columna, Fila, columna, "Importe total de la operación exonerada e inafecta")
        End If
    ...
    If FlagMGrv1 Or FlagMIgv1 Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila, columna + 1, "Adquisiciones Gravadas destinadas a operaciones gravadas y/o de exportación")
    ...
    If FlagMGrv2 Or FlagMIgv2 Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila, columna + 1, "Adquisiciones Gravadas destinadas a operaciones gravadas y/o de exportación y a operaciones no gravadas")
    ...
    If FlagPerRet Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, IIf(TipoReg = 1, "Retención", "Percepción"))
        columna = columna + 1
    End If
    ...
    If FlagNoDom Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila + 2, columna, "Nº de Comprobante de pago emitido por sujeto no domiciliado")
        columna = columna + 1
    End If
    
    If FlagDetracNum Or FlagDetracFec Then
        Call SetEstiloCab(o_Hoja, Fila, columna, Fila, columna + 1, "Constancia de depósito de detracción")
        
        Call SetEstiloCab(o_Hoja, Fila + 1, columna, Fila + 2, columna, "Número")
        columna = columna + 1
        Call SetEstiloCab(o_Hoja, Fila + 1, columna, Fila + 2, columna, "Fecha de Emisión")
        columna = columna + 1
    End If
    ...
    If FlagRFecha Or FlagRTipo Or FlagRSerie Or FlagRNumero Then
        ...
        If FlagRNumero Then
            Call SetEstiloCab(o_Hoja, Fila + 1, columna + NumRCampos, Fila + 2, columna + NumRCampos, "Nº del comprobante o documento", 15)
            NumRCampos = NumRCampos + 1
        End If
