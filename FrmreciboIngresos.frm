...
Begin VB.Form FrmreciboIngresos 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   6750
   ClientLeft      =   0
   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":0000
            Key             =   "(Aceptar)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":031C
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":077C
            Key             =   "(Imprimir)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":0809
            Key             =   "(Inicio)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":0C69
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":0F85
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":13E5
            Key             =   "(Quitar)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":1701
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":1B61
            Key             =   "(Red)"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":1FC1
            Key             =   "(Grabar)"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":28A1
            Key             =   "(Agregar)"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":2BBD
            Key             =   "(Buscar)"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmreciboIngresos.frx":2ED9
            Key             =   "(Cancelar)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmreciboIngresos"
...
Me.DtpValor.Value = KEY_FECHA
  ...
  strCadena = "SELECT * FROM almacen_comprobante WHERE id_doc='0108' AND ruc='" & KEY_RUC & "' AND id_alm='" & Me.DtcAlmacen.BoundText & "'"
  Call ConfiguraRst(strCadena)
  If rst.RecordCount < 1 Then
        strCadena = "INSERT INTO almacen_comprobante(ruc,id_alm,id_doc,serie,numero)VALUES ('" & KEY_RUC & "','" & Me.DtcAlmacen.BoundText & "','0108','001','000001')"
        CnBd.Execute (strCadena)
...
saldof = 0
        If Me.OptChequeSi.Value = False Then
                ...
                '-------END
                    ...
                    "'" & KEY_FECHA & "','" & Me.TxtRuc.Text & "','" & Trim(Me.TxtObservacion.Text) & "','" & monto_pagado & "','" & monto_pagado & "'," & _
...
On Error GoTo Error
  Select Case Button.key
    ...
    Case KEY_PRINT
        ...
        'strCadena = "select * from MIS_CUENTAS_DET where id_cuenta='" & Trim(Me.DtcCuentas.BoundText) & "' AND ruc='" & KEY_RUC & "'"
        'Call ConfiguraRst(strCadena)
        'If rst.RecordCount > 0 Then
         '   Call Impresion(bountes)
        'E'lse
          '  MsgBox "ERROR DE IMPRESION"
         '   Exit Sub
       ' End If
