...
Begin VB.Form FrmDetalleUrbanizacion 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   5775
   ClientLeft      =   0
   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":0000
            Key             =   "(Aceptar)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":031C
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":077C
            Key             =   "(Inicio)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":0BDC
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":0EF8
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":1358
            Key             =   "(Quitar)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":1674
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":1AD4
            Key             =   "(Red)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":1F34
            Key             =   "(Grabar)"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":2814
            Key             =   "(Agregar)"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":2B30
            Key             =   "(Buscar)"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmDetalleUrbanizacion.frx":2E4C
            Key             =   "(Cancelar)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmDetalleUrbanizacion"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim cCodigo As Double
Private Sub llenarGrid(ByVal Grilla As MSHFlexGrid, ByVal idDistrito As String)
'On Error GoTo salir
strCadena = "SELECT id_urbanizacion, descripcion FROM  urbanizacion WHERE id_distrito='" & idDistrito & "'"
...
End If
   ...
   Grilla.Rows = 0
       ...
       For Each Campo In rst.Fields
        ...
        Next
        cabecera = "CODIGO" & vbTab & "URBANIZACION"
        ...
        For i = 0 To rst.RecordCount - 1
            ...
            Fila = Fila & rst("id_urbanizacion") & vbTab & rst("descripcion")
            If (Fila = "") Then
                X = 1
            End If
          Grilla.AddItem Fila
...
If Me.TxtDescripcionActualizar.Text = "" Then
    ...
    Exit Sub
Else
    strCadena = "UPDATE urbanizacion SET Descripcion='" & Me.TxtDescripcionActualizar.Text & "' where id_Urbanizacion='" & Val(Me.HfVinculados.TextMatrix(Me.HfVinculados.Row, 0)) & "'"
    CnBd.Execute (strCadena)
     
    Call llenarGrid(Me.HfVinculados, Me.DtcDistrito.BoundText)
...
If Me.txtDescripcion.Text = "" Then
    ...
    Exit Sub
Else
    strCadena = "INSERT INTO urbanizacion(descripcion,id_distrito)VALUES('" & Replace(Me.txtDescripcion.Text, "'", "") & "','" & Me.DtcDistrito.BoundText & "')"
    'CnBd.Execute (strCadena)
     
    IdUrbanizacion = ConsultaUltInsert(strCadena)
    strCadena = "INSERT INTO zona(descripcion_zona,id_Urbanizacion)VALUES('ZONA 1','" & IdUrbanizacion & "')"
    CnBd.Execute (strCadena)
...
strCadena = "SELECT id_provincia as Codigo,descripcion as  Descripcion FROM provincia ORDER BY descripcion"
Call ConfiguraRst(strCadena)
Call LlenaDataCombo(Me.DtcProvincia)
Me.DtcProvincia.BoundText = FrmZonas.HfgZona.TextMatrix(FrmZonas.HfgZona.Row, 1)


strCadena = "SELECT id_distrito as Codigo,descripcion as  Descripcion FROM distrito ORDER BY descripcion"
Call ConfiguraRst(strCadena)
...
Call llenarGrid(Me.HfVinculados, FrmZonas.HfgZona.TextMatrix(FrmZonas.HfgZona.Row, 2))
