...
Begin VB.Form FrmListadoFacturasSinDestino 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   8685
   ClientLeft      =   0
   ...
   Begin VB.CommandButton Command1 
      Height          =   325
      Left            =   12000
      Picture         =   "FrmListadoFacturasSinDestino.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   240
      Width           =   495
   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmListadoFacturasSinDestino.frx":014A
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmListadoFacturasSinDestino.frx":059E
            Key             =   "(Visualizar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmListadoFacturasSinDestino.frx":0B38
            Key             =   "(Pagos)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmListadoFacturasSinDestino.frx":10D2
            Key             =   "(Monto)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmListadoFacturasSinDestino"
...
"FROM DocumentoCompra INNER JOIN Comprobantes ON DocumentoCompra.doc_cod = Comprobantes.doc_cod WHERE   tipo_factura='egreso' AND destino='no' AND (DocumentoCompra.doc_cod='0001' OR DocumentoCompra.doc_cod='0003') ORDER BY DocumentoCompra.dVencimiento ASC "
    ...
    If KeyAscii = 13 Then
        If frmNuevoComprobante.Procedencia = buscar Then
            ...
            If rst.RecordCount > 0 Then
                    If rst("tipo_factura") = "egreso" Then
                         
                         
                         
                         frmNuevoComprobante.FrameIntacta.Visible = True
                         ...
                         frmNuevoComprobante.TxtTotalImporte.Text = Format(rst("saldo"), "###0.00")
                         frmNuevoComprobante.TxtMontoFactura.Text = Format(rst("nTotalCompra"), "###0.00")
                        Call frmNuevoComprobante.precionarCompraEgreso
                        Unload Me
                    End If
