...
Begin VB.Form FrmRegistroMayor 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   8775
   ClientLeft      =   0
   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":0000
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":0454
            Key             =   "(Ple)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":37A2
            Key             =   "(Importar)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":3E74
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":4194
            Key             =   "(Exportar)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":4866
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":4CBA
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":510E
            Key             =   "(RCompras)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRegistroMayor.frx":6880
            Key             =   "(RVentas)"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmRegistroMayor"
...
strCadena = "SELECT ruc,mes,R.descripcion,anio, R.debe ,R.haber,razon FROM registro_mayor R ORDER BY R.anio,R.mes"
Call llenarGrid(Me.HfdPersona, Me)
    ...
    Case KEY_DELETE
      If MsgBox(MSGELIMINAR, vbQuestion + vbYesNo, MSGVERIFICACION) = vbYes Then
        If MsgBox("Se Borraran Todos los registros relacionados", vbQuestion + vbYesNo) = vbYes Then
            ...
            strCadena = "DELETE FROM registro_mayor WHERE ruc='" & Trim(Me.HfdPersona.TextMatrix(Me.HfdPersona.Row, 0)) & "' AND mes='" & Trim(Me.HfdPersona.TextMatrix(Me.HfdPersona.Row, 1)) & "' AND anio='" & Trim(Me.HfdPersona.TextMatrix(Me.HfdPersona.Row, 3)) & "'"
            CnBd.Execute (strCadena)
             
            strCadena = "DELETE FROM registro_mayor_detalle WHERE ruc='" & Trim(Me.HfdPersona.TextMatrix(Me.HfdPersona.Row, 0)) & "' AND id_mes='" & Trim(Me.HfdPersona.TextMatrix(Me.HfdPersona.Row, 1)) & "' AND id_anio='" & Trim(Me.HfdPersona.TextMatrix(Me.HfdPersona.Row, 3)) & "'"
            CnBd.Execute (strCadena)
...
End If
      ...
      ' Me.HfdGrilla.Rows = rst.RecordCount - 2
       ...
       For Each Campo In rst.Fields
        ...
        Acumulado = 0
        For i = 0 To rst.RecordCount - 1
            strCadena = "SELECT SUM(debe),sum(haber) FROM registro_mayor_detalle WHERE id_anio='" & rst("anio") & "' AND id_mes='" & Trim(rst("mes")) & "' AND ruc='" & Trim(rst("ruc")) & "'  "
            Call ConfiguraTemporal(strCadena)
