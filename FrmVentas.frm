...
On Error GoTo salir
    ...
    End If
    Else
        MsgBox "LA SERIE DE " + Chr(32) & Me.DtcTipoDoc.Text & Space(1) & "NO ESTA REGISTRADA." + Chr(13) + Chr(13) + "REGISTRE EN EL MODULO DE COMPROBANTES Ó" + Chr(13) + "CAMBIE DE SERIE.", vbInformation, KEY_EMPRESA
...
If Me.frmbanco.Visible = True And (Trim(Me.txtCheque.Text) = "" Or Trim(Me.txtBanco.Text) = "") Then
   MsgBox "Seleccione Un Banco y un Nº Cheque", vbInformation, "PAGO CON CHEQUE"
   Call Resalta(Me.txtCheque)
   Exit Sub
End If
...
If KeyAscii = 13 Then
    ...
    Else
            ...
            If MsgBox("ESTA SEGURO DE REALIZAR ESTA OPERACIÓN", vbQuestion + vbYesNo, KEY_EMPRESA) = vbYes Then
mostrar:
...
Iniciar:
            ...
            If Abs(Round(get_total_detalle(id_venta), 2) + Val(Me.lblicbper.Caption) - Round(TotalVenta + Val(Me.TxtDescuento_global.Text), 2)) > 0.2 Then
                ...
                Else
                    Call eliminar_error
                    MsgBox "Este comprobante tiene Inconsistencia." + Chr(13) + "Consulte con el Area de Sistemas ó" + Chr(13) + "Genere Nuevamente.", vbInformation
                    Exit Function
                End If
...
avanzar2:
         ...
         If Val(Me.lblCantidad.Caption) < 1 Then
            MsgBox "Nota:" + Chr(13) + "DEBE TENER UN ITEM como mínimo.", vbExclamation
            validar_comprobante_electronico = False
            Exit Function
         End If
