...
Begin VB.Form FrmDetalleDebito 
   ...
   End
End
Attribute VB_Name = "FrmDetalleDebito"
...
'id_tipo_doc = FrmReporteRecaudacionDiaria.HfgVisa.TextMatrix(FrmReporteRecaudacionDiaria.HfgVisa.Row, 4)
'id_codigo = FrmReporteRecaudacionDiaria.HfgVisa.TextMatrix(FrmReporteRecaudacionDiaria.HfgVisa.Row, 5)
'id_serie = FrmReporteRecaudacionDiaria.HfgVisa.TextMatrix(FrmReporteRecaudacionDiaria.HfgVisa.Row, 6)
'id_numero = FrmReporteRecaudacionDiaria.HfgVisa.TextMatrix(FrmReporteRecaudacionDiaria.HfgVisa.Row, 7)
