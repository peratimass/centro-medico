   ...
   Begin MSComctlLib.ImageList ImgIconos 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":0000
            Key             =   "(Nuevo)"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":0454
            Key             =   "(Modificar)"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":0774
            Key             =   "(Eliminar)"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":0BC8
            Key             =   "(Salir)"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":101C
            Key             =   "(Aceptar)"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":133C
            Key             =   "(Cancelar)"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":165C
            Key             =   "(Quitar)"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":197C
            Key             =   "(Agregar)"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmLinea.frx":1C9C
            Key             =   "(Buscar)"
         EndProperty
      EndProperty
   End
...
strCadena = "SELECT id_linea as Codigo,descripcion as Descripcion FROM linea WHERE descripcion LIKE '%" & Trim(Me.TxtLinea.Text) & "%' AND id_usu='" & KEY_RUC & "'ORDER BY descripcion ASC"
Call llenarGrid(Me.HfgLinea, Me)
End Sub
  ...
  Select Case Button.key
    ...
    Case KEY_DELETE
      If MsgBox(MSGELIMINAR, vbQuestion + vbYesNo, MSGVERIFICACION) = vbYes Then
        strCadena = "SELECT * FROM producto WHERE id_linea='" & Trim(Me.HfgLinea.TextMatrix(Me.HfgLinea.Row, 0)) & "' AND ruc='" & KEY_RUC & "'"
        ...
        If rst.RecordCount > 0 Then
            ...
            Exit Sub
        Else
        strCadena = "DELETE FROM linea WHERE id_linea='" & Trim(Me.HfgLinea.TextMatrix(Me.HfgLinea.Row, 0)) & "' and id_usu='" & KEY_RUC & "'"
