...
Public Sub actualizar()
 strCadena = "SELECT id_und as Código,descripcion as Unidad, abreviatura  as Abrev FROM unidad WHERE id_usu='" & KEY_RUC & "'ORDER BY descripcion ASC"
...
strCadena = "SELECT id_und as Código,descripcion as Unidad, abreviatura " & _
