...
Begin VB.Form FrmDetalleMastercard 
   BackColor       =   &H00FFFFFF&
   ...
   End
End
Attribute VB_Name = "FrmDetalleMastercard"
...
'id_tipo_doc = FrmReporteRecaudacionDiaria.HfgMastercard.TextMatrix(FrmReporteRecaudacionDiaria.HfgMastercard.Row, 4)
'id_codigo = FrmReporteRecaudacionDiaria.HfgMastercard.TextMatrix(FrmReporteRecaudacionDiaria.HfgMastercard.Row, 5)
'id_serie = FrmReporteRecaudacionDiaria.HfgMastercard.TextMatrix(FrmReporteRecaudacionDiaria.HfgMastercard.Row, 6)
'id_numero = FrmReporteRecaudacionDiaria.HfgMastercard.TextMatrix(FrmReporteRecaudacionDiaria.HfgMastercard.Row, 7)
