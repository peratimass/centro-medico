...
Begin VB.Form FrmDetalleDeudas 
   Caption         =   "Form1"
   ClientHeight    =   4575
   ClientLeft      =   60
   ClientTop       =   450
   ...
   End
End
Attribute VB_Name = "FrmDetalleDeudas"
...
'id_tipo_doc = FrmReporteRecaudacionDiaria.HfgPagosdeudas.TextMatrix(FrmReporteRecaudacionDiaria.HfgPagosdeudas.Row, 4)
'id_codigo = FrmReporteRecaudacionDiaria.HfgPagosdeudas.TextMatrix(FrmReporteRecaudacionDiaria.HfgPagosdeudas.Row, 5)
'id_serie = FrmReporteRecaudacionDiaria.HfgPagosdeudas.TextMatrix(FrmReporteRecaudacionDiaria.HfgPagosdeudas.Row, 6)
'id_numero = FrmReporteRecaudacionDiaria.HfgPagosdeudas.TextMatrix(FrmReporteRecaudacionDiaria.HfgPagosdeudas.Row, 7)
